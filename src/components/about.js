        ...
        <>
            ...
            <div className="aboutsection">
                ...
                <div className="about-text-main">
                    ...
                    <p className="paragraphs">I'm a Software Developer based in Nashville, TN.<br></br> My colleagues have described me as:</p>
                ...
                <div className="about-text-main">
                    ...
                    <p className="paragraphs">I enjoy the challenge and ongoing learning process of being a developer. I have established a solid foundation with JavaScript and React library.<br></br>
                    My desgin and styling skills are achieved through my knowledge of CSS, SASS, Figma, and Photoshop.<br></br>
                ...
                <div className="about-text-main">
                    ...
                    <div><h1>UI/UX</h1></div>
                    <p className="paragraphs">I find myself naturally drawn to the user experience and client-side. With my experiences in collaboration and leadership as an educator, I have always enjoyed the intrinsic rewards of helping others achieve their goals and overcome challenges.<br></br>
