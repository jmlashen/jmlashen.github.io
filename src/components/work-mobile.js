                ...
                <div className="worksection">
                    ...
                    <div className="first-box">
                        ...
                        <div className="prototype">
                            ...
                            <div className="proto-head" ><h4 className="h4">Prototypes</h4> </div>
                            
                                <p className="h6">Based on user data and group planning for the Cohort-51 Website, I created mobile and desktop prototypes for the project using Figma. Prototyping is one of my favorite processes that precede the launch of the final product and helps present a clear vision.
                                 <a target="_blank" href="https://github.com/nss-day-cohort-51/nss-day-cohort-51.github.io"> View all planning resources for the Cohort-51 Website Group Project here.</a></p>
                            </div>
                            </div>
